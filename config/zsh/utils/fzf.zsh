export FZF_DEFAULT_OPTS="--preview '~/.config/zsh/utils/file_preview {}'"
...
zstyle ':fzf-tab:complete:gd:*' fzf-preview '~/.config/zsh/utils/file_preview ${realpath} ${word}'
...
zstyle ':fzf-tab:complete:killall:*' fzf-preview '~/.config/zsh/utils/file_preview ${word} -kill'
...
zstyle ':fzf-tab:complete:*:*' fzf-preview '~/.config/zsh/file_preview ${(Q)realpath}'
